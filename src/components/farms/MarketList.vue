  ...
  <div class="market-list">
    <div class="mb-6">
      ...
      <div class="flex flex-wrap gap-4 mb-4">
        ...
        <select v-model="selectedCounty" class="select select-bordered" @change="handleSearch">
    ...
    <div v-else>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div v-for="market in markets" :key="market.id" class="card bg-base-100 shadow-xl">
          <div class="card-body">
      ...
      <div v-if="pagination" class="text-center mt-4 text-sm text-gray-600">
        第 {{ pagination.currentPage }} 頁，共 {{ pagination.totalPages }} 頁 （總共
