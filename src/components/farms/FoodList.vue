        ...
        <div class="flex flex-col lg:flex-row gap-4">
          ...
          <div class="flex-1">
            ...
            <div class="relative">
              ...
              />
              <PhMagnifyingGlass class="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />            </div>
          </div>
            ...
            <div>
              ...
              <div class="space-y-2 text-sm">
                <div v-if="selectedFood.address" class="flex items-start">
                  <PhMapPin class="h-4 w-4 mr-2 mt-0.5 text-gray-500" />                  <span>{{ selectedFood.address }}</span>
                </div>
